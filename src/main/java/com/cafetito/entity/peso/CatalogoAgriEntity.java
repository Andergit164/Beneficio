...
@Table(name = "catalogo",
        schema = "agricultor")
public class CatalogoAgriEntity {
    ...
    public CatalogoAgriEntity() {
    }

    public CatalogoAgriEntity(int codigo) {
        this.codigo = codigo;
    }

    public CatalogoAgriEntity(int codigo, int codigoCatalogo, String nombre, String descripcion, String usuarioAgrego, Date fechaAgrego, String usuarioModifico, Date fechaModifico) {
        this.codigo = codigo;
